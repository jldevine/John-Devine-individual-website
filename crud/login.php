<?php	
	...
	if(isset($_POST['loginSubmit'])) // If the user pressed the Submit button
	{
		...
		if ($uname == "username" && $pass == "password")
		{
			...
			if ($_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~jldevin1/individual%20website/crud/index.php" 
			    || $_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~jldevin1/individual%20website/crud/login.php" )
			{
		...
		<div class="panel panel-default" style="box-shadow: 2px 2px 7px #888888;">
			<div class="panel-heading"><b>Login</b></div>
				...
				<?php
					...
					<input type="text" size="10" name="username" class="form-control" value="username" placeholder="username">
					<input type="password" size="10" name="password" style="margin-top: 5px;" value="password" class="form-control" placeholder="password"><br>
					'.$error.'
